...
public class Order {
    ...
    public Order(String id, Time date, ContainerList size, String addressId) {
        this.order_id = id;
    ...
    public ContainerList getContainer() {return container_list;}
    ...
    public String toString() {
        return "Order id: " + order_id + ". " + cutoff_date.toString()
                + ". " + container_list.toString() + ". Detination: " + addressId;
    }
...
//        }
           Order o = new Order("Akl100", new Time(119,2,5),new ContainerList(20,20),"AKL");
